...
public class KDHDestroyIcon4 : MonoBehaviour
{

    int[] add = new int[8] { 0, 0, 0, 0, 0, 0, 0, 0 };
    public GameObject icon, sound, JudgementLine;
    ...
    void Start()
    {
        IconButton[0] = GameObject.Find("WhiteDownButton");
        JudgementLine = GameObject.Find("JudgementLine");
        IconButton[5] = GameObject.Find("BlueDownButton");
        ...
        IconButton[7] = GameObject.Find("WhiteRightButton");
